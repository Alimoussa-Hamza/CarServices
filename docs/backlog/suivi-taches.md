...
| O — Mobile pro (M12) | 8/11 | prochaine **N12** planning · cahier [`m12-cahier.md`](m12-cahier.md) |
...
- [x] **CS-M10-S04** CRUD catalog admin
  - [x] Categories / offers / options (soft-disable `isActive` / `isEnabled`)
- [x] **CS-M10-S05** CRUD zones + pricing
...
- [x] **CS-M11-S04** Parcours booking C04–C07 (formule→créneau)
...
- [x] **CS-M12-S05** P03 Détail + accept/decline — **N09** `[x]`
- [x] **CS-M12-S06** P04 En route + Maps + tel client — **N10** `[x]`
- [x] **CS-M12-S07** P05 Checklist + upload photos — **N11** `[x]`
...
- [x] **CS-M13-S08** A09 Settings config plateforme
